  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 ">
      ...
      <div className="flex gap-4">
        ...
        >
          <PlusIcon className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-indigo-300 to-indigo-300 text-white rounded-full" />
        ...
        >
          <UploadCloudIcon className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-purple-300 to-purple-300 text-white rounded-full" />
