            ...
            <div className="relative w-full">
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                {resumeData.public && (
                  <button
                    onClick={handleShare}
                    className=" flex items-center p-2 bg-gradient-to-br from-blue-100 to-blue-200  text-blue-600 ring hover:ring transition-all rounded-md px-4   text-xs"
                  >
                ...
                <button
                  ...
                  className="flex items-center py-2 px-4 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 ring-green-300 rounded-lg hover:ring transition-colors"
                >
